...
export default function DashboardView({ tickets = [], departments = [], users = [], onSelectTicket }) {
                ...
                {tickets.filter(t => t.status !== 'resolved' && t.priority === 'high').slice(0, 4).map(ticket => (
                   ...
                   >
                      <div className="flex items-center gap-3">
                         <div className="w-8 h-8 rounded-lg bg-rose-100 dark:bg-rose-900/20 text-rose-600 flex items-center justify-center font-bold text-xs">!</div>
                         <div>
                      ...
                      <div className="text-right">
                         <span className="block text-[10px] font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded-full border border-amber-100">Urgent</span>
                      </div>
                   </div>
                ))}
